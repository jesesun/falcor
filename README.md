...
**1.0.0** final is now available in npm. Users of the technical preview are welcome to upgrade, with **1.0.0** representing the typical backwards compatibility guarantees of a major semver release.
